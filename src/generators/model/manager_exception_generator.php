...
fwrite($file, " * Exceptions with code 1 are due to problem detected in the manager according msolm logic.\n");
...
fwrite($file, "\n");
fwrite($file, "	public function __construct(\$message = '', \$code = 0, \$e = null) {\n");
